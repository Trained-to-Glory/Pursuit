...
class FeedChallengeCells : UICollectionViewCell {
    ...
    func setupAddedUser(){
        ...
        addedUserPhoto.anchor(top: topAnchor, left: nil, bottom: nil, right: rightAnchor, paddingTop: 24, paddingLeft: 0, paddingBottom: 0, paddingRight: 12, width: 60, height: 60)
    ...
    func setupView(){
        ...
        userPhoto.anchor(top: topAnchor, left: leftAnchor, bottom: nil, right: nil, paddingTop: 24, paddingLeft: 12, paddingBottom: 0, paddingRight: 0, width: 60, height: 60)
